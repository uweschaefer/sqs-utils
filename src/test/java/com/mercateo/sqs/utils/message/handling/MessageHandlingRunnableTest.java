...
public class MessageHandlingRunnableTest {
  ...
  @Mock private SetWithUpperBound<String> messages;

  @Mock private ScheduledFuture<?> visibilityTimeoutExtender;
  ...
  public void setUp() throws Exception {
    ...
    uut =
        new MessageHandlingRunnable<>(
            worker, message, finishedMessageCallback, messages, visibilityTimeoutExtender);
  }
