...
public class VisibilityTimeoutExtender implements Runnable {
  ...
  VisibilityTimeoutExtender(
      ...
      @NonNull Duration newVisibilityTimeout,
    ...
    request =
        new ChangeMessageVisibilityRequest()
            ...
            .withReceiptHandle(message.getHeaders().get("ReceiptHandle", String.class))
            .withVisibilityTimeout(timeoutInSeconds(newVisibilityTimeout));
  }
