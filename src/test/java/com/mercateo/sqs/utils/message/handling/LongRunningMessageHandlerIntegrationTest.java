...
public class LongRunningMessageHandlerIntegrationTest {
  ...
  public void setUp() throws Exception {
    ...
    VisibilityTimeoutExtenderFactory timeoutExtenderFactory =
        new VisibilityTimeoutExtenderFactory(sqsClient);
  ...
  public void testHandleMessage_processesFourMessagesAndFillsQueue() {
    ...
    assertThat(uut.getMessagesInProcessing().getBackingSet())
        .containsOnly("messageId1", "messageId2", "messageId3", "messageId4");
  ...
  public void testHandleMessage_processesSixMessageAndCrashes() {
    ...
    // then
    assertThat(uut.getMessagesInProcessing().getBackingSet())
        .containsOnly("messageId1", "messageId2", "messageId3", "messageId4", "messageId5");
  }
