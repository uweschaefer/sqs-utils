...
public class LongRunningMessageHandlerTest {
  ...
  @Mock private ScheduledExecutorService timeoutExtensionExecutor;

  @Mock private MessageHandlingRunnableFactory messageHandlingRunnableFactory;

  @Mock private VisibilityTimeoutExtenderFactory timeoutExtenderFactory;

  @Mock private MessageWorkerWithHeaders<Integer, String> worker;

  @Mock private Queue queue;

  @Mock private FinishedMessageCallback<Integer, String> finishedMessageCallback;
  ...
  public void setUp() throws Exception {
    ...
    uut =
        new LongRunningMessageHandler<>(
            timeoutExtensionExecutor,
            1,
            1,
  ...
  public void testNullContracts() throws Exception {
    ...
    nullPointerTester.setDefault(VisibilityTimeoutExtenderFactory.class, timeoutExtenderFactory);
